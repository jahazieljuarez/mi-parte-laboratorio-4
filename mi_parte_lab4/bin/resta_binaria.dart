...
void main(List<String> args) {
  ...
  int resultado = restaDecimal;
  if (restaDecimal < 0) {
    restaDecimal = restaDecimal.abs();
  }
  int n = restaDecimal;
  ...
  if (resultado == 0) {
    print("la resta de estos dos numeros binarios es 0000");
    return;
  }
  if (resultado < 0) {
    print("la resta de estos dos numeros binarios es -$binario");
  } else {
    print("la resta de estos dos numeros binarios es $binario");
 
  }
  }catch (e) {
    print("ingrese numero binario 1,0");
  }
}
